...
{
    private static String appSecret = "bcee2d6d6c9e6c880df9d7a0010268a2f9297c29a42c9fe1ade37ad97e2ea0bd";
    private static  String appId = "100857393";//用户在华为开发者联盟申请的appId和appSecret（会员中心->应用管理，点击应用名称的链接）
    ...
    private static  void sendPushMessage() throws IOException
    {
        ...
        deviceTokens.add("0866953038641315300003858300CN01");
        deviceTokens.add("0864131038596993300003858300CN01");

        JSONObject body = new JSONObject();//仅通知栏消息需要设置标题和内容，透传消息key和value为用户自定义
        body.put("title", "还没有吗");//消息标题
        body.put("content", "还没有吗");//消息内容体
